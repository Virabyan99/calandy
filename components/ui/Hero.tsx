  ...
  return (
    <section className="relative flex flex-col items-center justify-center py-12 lg:py-20">
      <div className="text-center">
        <span className="text-sm text-gray-800 -mt-2 font-medium tracking-tight bg-yellow-500 px-4 py-2 rounded-full">
          Introducing CalendAndy 1.1
        </span>
        <h1 className="mt-8 text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-medium leading-none">
          Scheduling made <span className="block text-primary">super easy</span>
        </h1>
        <p className="max-w-xl mx-auto mt-4 lg:text-lg text-muted-foreground">
          Scheduling a meeting can be a pain. But we at CalendAndy make it easy
